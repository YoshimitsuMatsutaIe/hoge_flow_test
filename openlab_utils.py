...
class OpemLabKineatics:
    ...
    def origin_4(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[l2*sin(q2)*cos(q1) + l3*sin(q2 + q3)*cos(q1)], 
    ...
    def origin_5(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[(l2*sin(q2) + l3*sin(q2 + q3) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)))*cos(q1)], 
    ...
    def origin_6(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[(l2*sin(q2) + l3*sin(q2 + q3) + l5*sin(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)))*cos(q1)], 
    ...
    def origin_7(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[l2*sin(q2)*cos(q1) + l3*sin(q2 + q3)*cos(q1) + l5*sin(q2 + q3 + q4)*cos(q1) + l6*(sin(q1)*sin(q5) + cos(q1)*cos(q5)*cos(q2 + q3 + q4))*sin(q6) - l6*sin(q2 + q3 + q4)*cos(q1)*cos(q6) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4))*cos(q1)], 
    ...
    def jacobi_3(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[-l2*sin(q1)*sin(q2), l2*cos(q1)*cos(q2), 0, 0, 0, 0], 
                      [l2*sin(q2)*cos(q1), l2*sin(q1)*cos(q2), 0, 0, 0, 0], 
                      [0, -l2*sin(q2), 0, 0, 0, 0]])
        return z
    ...
    def jacobi_4(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[-(l2*sin(q2) + l3*sin(q2 + q3))*sin(q1), (l2*cos(q2) + l3*cos(q2 + q3))*cos(q1), l3*cos(q1)*cos(q2 + q3), 0, 0, 0], 
                      [(l2*sin(q2) + l3*sin(q2 + q3))*cos(q1), (l2*cos(q2) + l3*cos(q2 + q3))*sin(q1), l3*sin(q1)*cos(q2 + q3), 0, 0, 0], 
                      [0, -l2*sin(q2) - l3*sin(q2 + q3), -l3*sin(q2 + q3), 0, 0, 0]])
        return z
    
    def jacobi_5(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[-(l2*sin(q2) + l3*sin(q2 + q3) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l2*cos(q2) + l3*cos(q2 + q3) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l3*cos(q2 + q3) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (h45**2 + l4**2)**0.5*cos(q1)*cos(q2 + q3 + q4 + atan(h45/l4)), 0, 0], 
                      [(l2*sin(q2) + l3*sin(q2 + q3) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l2*cos(q2) + l3*cos(q2 + q3) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l3*cos(q2 + q3) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (h45**2 + l4**2)**0.5*sin(q1)*cos(q2 + q3 + q4 + atan(h45/l4)), 0, 0], 
                      [0, -l2*sin(q2) - l3*sin(q2 + q3) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), -l3*sin(q2 + q3) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), -(h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), 0, 0]])
        return z
    
    def jacobi_6(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[-(l2*sin(q2) + l3*sin(q2 + q3) + l5*sin(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l2*cos(q2) + l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l5*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), 0, 0], 
                      [(l2*sin(q2) + l3*sin(q2 + q3) + l5*sin(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l2*cos(q2) + l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l5*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), 0, 0], 
                      [0, -l2*sin(q2) - l3*sin(q2 + q3) - l5*sin(q2 + q3 + q4) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), -l3*sin(q2 + q3) - l5*sin(q2 + q3 + q4) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), -l5*sin(q2 + q3 + q4) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), 0, 0]])
        return z
    
    def jacobi_7(self, q):
        l0, l1, l2, l3, l4, l5, l6, h45 = self.L0, self.L1, self.L2, self.L3, self.L4, self.L5, self.L6, self.H45
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        z = np.array([[-l2*sin(q1)*sin(q2) - l3*sin(q1)*sin(q2 + q3) - l5*sin(q1)*sin(q2 + q3 + q4) - l6*(sin(q1)*cos(q5)*cos(q2 + q3 + q4) - sin(q5)*cos(q1))*sin(q6) + l6*sin(q1)*sin(q2 + q3 + q4)*cos(q6) - (h45**2 + l4**2)**0.5*sin(q1)*sin(q2 + q3 + q4 + atan(h45/l4)), (l2*cos(q2) + l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) - l6*sin(q6)*sin(q2 + q3 + q4)*cos(q5) - l6*cos(q6)*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) - l6*sin(q6)*sin(q2 + q3 + q4)*cos(q5) - l6*cos(q6)*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), (l5*cos(q2 + q3 + q4) - l6*sin(q6)*sin(q2 + q3 + q4)*cos(q5) - l6*cos(q6)*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*cos(q1), l6*(sin(q1)*cos(q5) - sin(q5)*cos(q1)*cos(q2 + q3 + q4))*sin(q6), l6*((sin(q1)*sin(q5) + cos(q1)*cos(q5)*cos(q2 + q3 + q4))*cos(q6) + sin(q6)*sin(q2 + q3 + q4)*cos(q1))], 
                      [l2*sin(q2)*cos(q1) + l3*sin(q2 + q3)*cos(q1) + l5*sin(q2 + q3 + q4)*cos(q1) + l6*(sin(q1)*sin(q5) + cos(q1)*cos(q5)*cos(q2 + q3 + q4))*sin(q6) - l6*sin(q2 + q3 + q4)*cos(q1)*cos(q6) + (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4))*cos(q1), (l2*cos(q2) + l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) - l6*sin(q6)*sin(q2 + q3 + q4)*cos(q5) - l6*cos(q6)*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l3*cos(q2 + q3) + l5*cos(q2 + q3 + q4) - l6*sin(q6)*sin(q2 + q3 + q4)*cos(q5) - l6*cos(q6)*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), (l5*cos(q2 + q3 + q4) - l6*sin(q6)*sin(q2 + q3 + q4)*cos(q5) - l6*cos(q6)*cos(q2 + q3 + q4) + (h45**2 + l4**2)**0.5*cos(q2 + q3 + q4 + atan(h45/l4)))*sin(q1), -l6*(sin(q1)*sin(q5)*cos(q2 + q3 + q4) + cos(q1)*cos(q5))*sin(q6), l6*((sin(q1)*cos(q5)*cos(q2 + q3 + q4) - sin(q5)*cos(q1))*cos(q6) + sin(q1)*sin(q6)*sin(q2 + q3 + q4))], 
                      [0, -l2*sin(q2) - l3*sin(q2 + q3) - l5*sin(q2 + q3 + q4) - l6*sin(q6)*cos(q5)*cos(q2 + q3 + q4) + l6*sin(q2 + q3 + q4)*cos(q6) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), -l3*sin(q2 + q3) - l5*sin(q2 + q3 + q4) - l6*sin(q6)*cos(q5)*cos(q2 + q3 + q4) + l6*sin(q2 + q3 + q4)*cos(q6) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), -l5*sin(q2 + q3 + q4) - l6*sin(q6)*cos(q5)*cos(q2 + q3 + q4) + l6*sin(q2 + q3 + q4)*cos(q6) - (h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4)), l6*sin(q5)*sin(q6)*sin(q2 + q3 + q4), l6*(sin(q6)*cos(q2 + q3 + q4) - sin(q2 + q3 + q4)*cos(q5)*cos(q6))]])
        return z
    ...
    def djacobi_3(self, q, dq):
        ...
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        dq1, dq2, dq3, dq4, dq5, dq6 = dq[0, 0], dq[1, 0], dq[2, 0], dq[3, 0], dq[4, 0], dq[5, 0]
        z = np.array([[-l2*(dq1*sin(q2)*cos(q1) + dq2*sin(q1)*cos(q2)), -l2*(dq1*sin(q1)*cos(q2) + dq2*sin(q2)*cos(q1)), 0, 0, 0, 0], [l2*(-dq1*sin(q1)*sin(q2) + dq2*cos(q1)*cos(q2)), l2*(dq1*cos(q1)*cos(q2) - dq2*sin(q1)*sin(q2)), 0, 0, 0, 0], 
    ...
    def djacobi_4(self, q, dq):
        ...
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        dq1, dq2, dq3, dq4, dq5, dq6 = dq[0, 0], dq[1, 0], dq[2, 0], dq[3, 0], dq[4, 0], dq[5, 0]
        z = np.array([[-dq1*l2*sin(q2)*cos(q1) - dq1*l3*sin(q2 + q3)*cos(q1) - dq2*l2*sin(q1)*cos(q2) - l3*(dq2 + dq3)*sin(q1)*cos(q2 + q3), -dq1*l2*sin(q1)*cos(q2) - dq1*l3*sin(q1)*cos(q2 + q3) - dq2*l2*sin(q2)*cos(q1) - l3*(dq2 + dq3)*sin(q2 + q3)*cos(q1), -l3*(dq1*sin(q1)*cos(q2 + q3) + (dq2 + dq3)*sin(q2 + q3)*cos(q1)), 0, 0, 0], [-dq1*l2*sin(q1)*sin(q2) - dq1*l3*sin(q2 + q3)*sin(q1) + dq2*l2*cos(q1)*cos(q2) + l3*(dq2 + dq3)*cos(q2 + q3)*cos(q1), 
dq1*l2*cos(q1)*cos(q2) + dq1*l3*cos(q2 + q3)*cos(q1) - dq2*l2*sin(q1)*sin(q2) - l3*(dq2 + dq3)*sin(q2 + q3)*sin(q1), l3*(dq1*cos(q2 + q3)*cos(q1) - (dq2 + dq3)*sin(q2 + q3)*sin(q1)), 0, 0, 0], [0, -dq2*l2*cos(q2) - l3*(dq2 + dq3)*cos(q2 + q3), -l3*(dq2 + dq3)*cos(q2 + q3), 0, 0, 0]])
        return z
    ...
    def djacobi_5(self, q, dq):
        ...
        q1, q2, q3, q4, q5, q6 = q[0, 0], q[1, 0], q[2, 0], q[3, 0], q[4, 0], q[5, 0]
        dq1, dq2, dq3, dq4, dq5, dq6 = dq[0, 0], dq[1, 0], dq[2, 0], dq[3, 0], dq[4, 0], dq[5, 0]
        z = np.array([[-dq1*l2*sin(q2)*cos(q1) - dq1*l3*sin(q2 + q3)*cos(q1) - dq1*(h45**2 + l4**2)**0.5*sin(q2 + q3 + q4 + atan(h45/l4))*cos(q1) - dq2*l2*sin(q1)*cos(q2) - l3*(dq2 + dq3)*sin(q1)*cos(q2 + q3) - (h45**2 + l4**2)**0.5*(dq2 + dq3 + dq4)*sin(q1)*cos(q2 + q3 + q4 + atan(h45/l4)), -dq1*l2*sin(q1)*cos(q2) - dq1*l3*sin(q1)*cos(q2 + q3) - dq1*(h45**2 + l4**2)**0.5*sin(q1)*cos(q2 + q3 + q4 + atan(h45/l4)) - dq2*l2*sin(q2)*cos(q1) - l3*(dq2 + dq3)*sin(q2 + q3)*cos(q1) - (h45**2 + l4**2)**0.5*(dq2 + dq3 + dq4)*sin(q2 + q3 + q4 + atan(h45/l4))*cos(q1), -dq1*l3*sin(q1)*cos(q2 + q3) - dq1*(h45**2 + l4**2)**0.5*sin(q1)*cos(q2 + q3 + q4 + atan(h45/l4)) - l3*(dq2 + dq3)*sin(q2 + q3)*cos(q1) - (h45**2 + l4**2)**0.5*(dq2 + dq3 + dq4)*sin(q2 + q3 + q4 + atan(h45/l4))*cos(q1), -(h45**2 + l4**2)**0.5*(dq1*sin(q1)*cos(q2 + q3 + q4 + atan(h45/l4)) + (dq2 + dq3 + dq4)*sin(q2 + q3 + q4 + atan(h45/l4))*cos(q1)), 0, 0], 
